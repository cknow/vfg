(function (global, factory) {
  ...
  var script$1 = {
      ...
      computed: {
          schemaParsed: function schemaParsed() {
          ...
          options: function options() {
              ...
              return merge_1({}, defaultTheme, themeDefault, optionsTheme, options, schemaTheme);
          }
      },
  ...
  function install (Vue, options) {
      ...
      var vfg = new Vue({
          ...
          methods: {
              addTheme: function addTheme(name, config) {
                  if (!this.hasTheme(name)) {
                      this.themes[name] = config;
                  }
              },

              addThemes: function addThemes(themes) {
                  var this$1 = this;

                  for (var i = 0, list = Object.entries(themes); i < list.length; i += 1) {
                      var ref = list[i];
                      var name = ref[0];
                      var config = ref[1];

                      this$1.addTheme(name, config);
                  }
              },
              ...
              hasTheme: function hasTheme(name) {
